...
<html lang="zxx" class="no-js">
    ...
    <body>
        ...
        <p style="text-align:center;margin-left:auto;margin-right:auto;font-size:40px;padding:30px;"> Learn Trading </p>
		<iframe style="align:center;display:block;margin-left:auto;margin-right:auto;padding:0px; "width="800" height="449" src="https://www.youtube.com/embed/txWaMpSzHhM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

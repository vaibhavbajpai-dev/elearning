						...
						<div class="col-lg-8 left-contents">
							...
							<div class="jq-tab-wrapper" id="horizontalTab">
	                            ...
	                            <div class="jq-tab-content-wrapper">
									...
									Upon completion of this lesson, students will be able to: <br>- define stock market<br>- list the indices of the stock market<br>- create a mock stock portfolio<br>
										<br>
	                                    Begin by asking the students to define the term 'stock market.' When each student has come up with a definition, ask them to share with the class for discussion. 
	                                ...
	                                <div class="jq-tab-content" data-tab="5">	
						                ...
						                <div class="comments-area mb-30">
											...
											<?php
												...
												$sql = "SELECT user_id, comment FROM feedback where course_id='4'";
							...
							<ul>
								<li>
									<a class="justify-content-between d-flex">
										<p>Trainer’s Name</p> 
										<span class="or">Warrior Trading</span>
									</a>
								</li>
								<li>
									<a class="justify-content-between d-flex">

...
<html lang="zxx" class="no-js">
    ...
    <body>
        ...
        <p style="text-align:center;margin-left:auto;margin-right:auto;font-size:40px;padding:30px;"> Web Development </p>
		<iframe style="align:center;display:block;margin-left:auto;margin-right:auto;padding:0px; "width="800" height="449" src="https://www.youtube.com/embed/hEZEZQbMOlQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		...
		<div class="quiz">
			<a href="web-development-quiz.php"><h3>Take a Quiz</h3></a><br/>
		</div>

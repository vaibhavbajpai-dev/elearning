				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="profile-courses.php"> Popular Courses</a></p>
						</div>	
					</div>
				</div>
			</section>
						...
						<div class="col-lg-8 left-contents">
							...
							<div class="jq-tab-wrapper" id="horizontalTab">
	                            ...
	                            <div class="jq-tab-content-wrapper">
									...
									Content Standard The learners demonstrate an understanding of the skills and tasks appropriate for middle and late adolescence, and preparatory to early adulthood.
									Performance Standard The learners shall be able to make a list of ways to become responsible adolescents prepared for adult life.
									Learning Competencies/Objectives The learners classify various developmental tasks according to developmental stage.
									The learners evaluate one’s development in comparison with persons of the same age group.<br>
										<br>
	                                    Learning Objectives The learners classify various developmental tasks according to developmental stage.
									The learners evaluate one’s development in comparison with persons of the same age group.<br>
										</div>
							...
							<ul>
								<li>
									<a class="justify-content-between d-flex">
										<p>Trainer’s Name</p> 
										<span class="or" >Think International</span>
									</a>
								</li>
								<li>
									<a class="justify-content-between d-flex">
			...
			<section class="popular-courses-area section-gap courses-page">
				<div class="container">
					...
					<div class="single-popular-carusel col-lg-3 col-md-6">
						...
						<a href="profile-courses.php" class="primary-btn text-uppercase mx-auto">Load More Courses</a>													
					</div>
				</div>	
			</section>

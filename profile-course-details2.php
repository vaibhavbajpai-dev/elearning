						...
						<div class="col-lg-8 left-contents">
							...
							<div class="jq-tab-wrapper" id="horizontalTab">
	                            ...
	                            <div class="jq-tab-content-wrapper">
									...
									Develop skills in analyzing the usability of a web site. Understand how to plan and conduct user research related to web usability. 
									Learn the language of the web: HTML and CSS. Learn techniques of responsive web design, including media queries. Learn CSS grid layout and flexbox. 
									Develop skills in digital imaging (Adobe Photoshop.) Be able to embed social media content into web pages.<br>
										<br>
	                                    Learn the language of the web: HTML and CSS. Learn techniques of responsive web design, including media queries. Learn CSS grid layout and flexbox. 
									Develop skills in digital imaging (Adobe Photoshop.) Be able to embed social media content into web pages.<br>
										</div>
	                                ...
	                                <div class="jq-tab-content" data-tab="5">	
						                ...
						                <div class="comments-area mb-30">
											...
											<?php
												...
												$sql = "SELECT user_id, comment FROM feedback where course_id='2'";
							...
							<ul>
								<li>
									<a class="justify-content-between d-flex">
										<p>Trainer’s Name</p> 
										<span class="or">Michael Thomas</span>
									</a>
								</li>
								<li>
